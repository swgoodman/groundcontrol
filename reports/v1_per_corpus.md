...
| groundcheck | Reveal | 600 | 0.868 | 0.872 | 0.981 | 0.063 | - | - | - | - | - |
| groundcheck | Lfqa | 600 | 0.828 | 0.789 | 0.861 | 0.037 | - | - | - | - | - |
| groundcheck | FactCheck-GPT | 600 | 0.762 | 0.861 | 0.923 | 0.059 | - | - | - | - | - |
| groundcheck | RAGTruth | 600 | 0.729 | 0.263 | 0.378 | 0.201 | - | - | - | - | - |
| groundcheck | ClaimVerify | 600 | 0.677 | 0.570 | 0.536 | 0.151 | - | - | - | - | - |
| zero-shot | FactCheck-GPT | 600 | 0.663 | 0.870 | 0.909 | 0.149 | - | - | - | - | - |
| zero-shot | AggreFact-CNN | 558 | 0.621 | 0.237 | 0.149 | 0.372 | - | - | - | - | - |
| groundcheck | TofuEval-MediaS | 600 | 0.615 | 0.431 | 0.333 | 0.220 | - | - | - | - | - |
| zero-shot | Lfqa | 600 | 0.615 | 0.620 | 0.706 | 0.369 | - | - | - | - | - |
| groundcheck | TofuEval-MeetB | 600 | 0.612 | 0.393 | 0.365 | 0.195 | - | - | - | - | - |
| groundcheck | Wice | 358 | 0.600 | 0.782 | 0.783 | 0.108 | - | - | - | - | - |
| groundcheck | ExpertQA | 600 | 0.594 | 0.374 | 0.283 | 0.252 | - | - | - | - | - |
...
| groundcheck | AggreFact-XSum | 558 | 0.513 | 0.651 | 0.569 | 0.452 | - | - | - | - | - |
| zero-shot | ClaimVerify | 600 | 0.510 | 0.473 | 0.436 | 0.558 | - | - | - | - | - |
| groundcheck | AggreFact-CNN | 558 | 0.509 | 0.034 | 0.164 | 0.075 | - | - | - | - | - |
| zero-shot | RAGTruth | 600 | 0.507 | 0.147 | 0.095 | 0.577 | - | - | - | - | - |

## Contamination

- `groundcheck` trained on ['ragtruth'], which `RAGTruth` contains, so this result is in-domain and not comparable to a zero-shot entry.
...
|---|---|---|---|---|---|---|---|
| groundcheck | RAGTruth | 0.080 | 0.017 | 0.037 | 0.080 | 41.5% | 0.77 |
| zero-shot | RAGTruth | 0.080 | 0.060 | 0.075 | 0.080 | 1.8% | 0.15 |
| groundcheck | ExpertQA | 0.202 | 0.137 | 0.183 | 0.202 | 4.5% | 0.29 |
| zero-shot | ExpertQA | 0.202 | 0.153 | 0.185 | 0.202 | 0.2% | 0.22 |
| groundcheck | Lfqa | 0.387 | 0.077 | 0.258 | 0.387 | 23.0% | 0.88 |
| zero-shot | Lfqa | 0.387 | 0.167 | 0.285 | 0.387 | 13.0% | 0.72 |
| groundcheck | Reveal | 0.783 | 0.580 | 0.729 | 0.783 | 0.5% | 0.83 |
| zero-shot | Reveal | 0.783 | 0.577 | 0.729 | 0.783 | 1.5% | 0.83 |
| groundcheck | FactCheck-GPT | 0.738 | 0.560 | 0.683 | 0.738 | 2.5% | 0.66 |
| zero-shot | FactCheck-GPT | 0.738 | 0.580 | 0.683 | 0.738 | 2.5% | 0.62 |
| groundcheck | ClaimVerify | 0.313 | 0.153 | 0.250 | 0.313 | 1.5% | 0.58 |
| zero-shot | ClaimVerify | 0.313 | 0.233 | 0.281 | 0.313 | 0.7% | 0.26 |
| groundcheck | TofuEval-MeetB | 0.205 | 0.113 | 0.175 | 0.205 | 3.0% | 0.45 |
| zero-shot | TofuEval-MeetB | 0.205 | 0.133 | 0.167 | 0.205 | 1.7% | 0.34 |
| groundcheck | TofuEval-MediaS | 0.235 | 0.157 | 0.206 | 0.235 | 0.7% | 0.38 |
| zero-shot | TofuEval-MediaS | 0.235 | 0.157 | 0.210 | 0.235 | 3.0% | 0.46 |
| groundcheck | AggreFact-CNN | 0.102 | 0.075 | 0.078 | 0.102 | 1.6% | 0.24 |
| zero-shot | AggreFact-CNN | 0.102 | 0.065 | 0.090 | 0.102 | 6.6% | 0.43 |
| groundcheck | AggreFact-XSum | 0.489 | 0.455 | 0.462 | 0.489 | 0.0% | 0.16 |
| zero-shot | AggreFact-XSum | 0.489 | 0.398 | 0.453 | 0.489 | 0.7% | 0.35 |
| groundcheck | Wice | 0.690 | 0.609 | 0.668 | 0.690 | 1.7% | 0.37 |
...
### groundcheck on TofuEval-MediaS
